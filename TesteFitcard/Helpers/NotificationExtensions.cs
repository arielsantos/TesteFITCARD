...
namespace TesteFitcard.Helpers
{
    public static class NotificationExtensions
    {
        private static IDictionary<String, String> NotificationKey = new Dictionary<String, String>
        {
            ...
            { "Sucesso",    "App.Notifications.Success" },
        ...
        public static void LoadNotification(this ControllerBase controller)
        {
            ICollection<String> messages = controller.TempData[NotificationType.ERROR] as ICollection<String>;
